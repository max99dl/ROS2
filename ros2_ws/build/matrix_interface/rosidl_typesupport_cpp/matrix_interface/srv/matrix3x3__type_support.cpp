...
static const _Matrix3x3_Request_type_support_symbol_names_t _Matrix3x3_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, matrix_interface, srv, Matrix3x3_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, matrix_interface, srv, Matrix3x3_Request)),
  }
};
...
{
  return &::matrix_interface::srv::rosidl_typesupport_cpp::Matrix3x3_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, matrix_interface, srv, Matrix3x3_Request)() {
  return get_message_type_support_handle<matrix_interface::srv::Matrix3x3_Request>();
}
...
static const _Matrix3x3_Response_type_support_symbol_names_t _Matrix3x3_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, matrix_interface, srv, Matrix3x3_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, matrix_interface, srv, Matrix3x3_Response)),
  }
};
...
{
  return &::matrix_interface::srv::rosidl_typesupport_cpp::Matrix3x3_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, matrix_interface, srv, Matrix3x3_Response)() {
  return get_message_type_support_handle<matrix_interface::srv::Matrix3x3_Response>();
}
...
static const _Matrix3x3_type_support_symbol_names_t _Matrix3x3_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, matrix_interface, srv, Matrix3x3)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, matrix_interface, srv, Matrix3x3)),
  }
};
...
{
  return &::matrix_interface::srv::rosidl_typesupport_cpp::Matrix3x3_service_type_support_handle;
}
