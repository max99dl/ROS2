...
#define NODE_MAIN_LOGGER_NAME "listener"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblistener_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<MinimalSubscriber>";
