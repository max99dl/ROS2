...
# Import target "cpp_srvcli::client_component" for configuration ""
set_property(TARGET cpp_srvcli::client_component APPEND PROPERTY IMPORTED_CONFIGURATIONS NOCONFIG)
set_target_properties(cpp_srvcli::client_component PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/libclient_component.so"
  IMPORTED_SONAME_NOCONFIG "libclient_component.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS cpp_srvcli::client_component )
list(APPEND _IMPORT_CHECK_FILES_FOR_cpp_srvcli::client_component "${_IMPORT_PREFIX}/lib/libclient_component.so" )
