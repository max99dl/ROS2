...
#define NODE_MAIN_LOGGER_NAME "server"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libserver_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<MinimalServer>";
