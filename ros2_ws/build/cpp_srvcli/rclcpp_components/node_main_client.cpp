...
#define NODE_MAIN_LOGGER_NAME "client"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libclient_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<MinimalClient>";
