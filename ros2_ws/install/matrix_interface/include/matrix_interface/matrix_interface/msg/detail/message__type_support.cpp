...
{
  new (message_memory) matrix_interface::msg::Message(_init);
}

void Message_fini_function(void * message_memory)
{
  auto typed_message = static_cast<matrix_interface::msg::Message *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Message_message_member_array[1] = {
  {
    ...
    offsetof(matrix_interface::msg::Message, message),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Message_message_members = {
  "matrix_interface::msg",  // message namespace
  "Message",  // message name
  1,  // number of fields
  sizeof(matrix_interface::msg::Message),
...
{
  return &::matrix_interface::msg::rosidl_typesupport_introspection_cpp::Message_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, matrix_interface, msg, Message)() {
  return &::matrix_interface::msg::rosidl_typesupport_introspection_cpp::Message_message_type_support_handle;
}
